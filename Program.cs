...
namespace test
{
    static class Program
    {
        ...
        static string mainFEN = "RNBQKBNR/PPPPPPPP/8/8/8/8/pppppppp/rnbqkbnr w kqKQ 0 0";          
                // test psoition 2b3kr/2p1qppp/r1n5/2p5/pb1pB1RP/N4N2/PP1BQPP1/2R3K1 w 0 0
        ...
        static void Main()
        {
            ...
            board = Functions.GenerateBoard(formatFEN[0]);     //
            ...
            while (gameOn)
            {
                Console.Clear();
                Graphics.WriteHint();
                Graphics.WriteBoard(board, large, formatFEN);
